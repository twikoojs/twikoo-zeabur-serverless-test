...
class CloudBase {
    ...
    init(config = {}) {
        ...
        if ((secretId && !secretKey) || (!secretId && secretKey)) {
            throw (0, utils_1.E)(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'secretId and secretKey must be a pair' }));
        }
    ...
    callFunction(callFunctionOptions, opts) {
        return (0, functions_1.callFunction)(this, callFunctionOptions, opts);
    }
    auth() {
    ...
    callWxOpenApi(wxOpenApiOptions, opts) {
        return (0, wx_1.callWxOpenApi)(this, wxOpenApiOptions, opts);
    }
    /**
     * wxpayapi调用
     *
    ...
    callWxPayApi(wxOpenApiOptions, opts) {
        return (0, wx_1.callWxPayApi)(this, wxOpenApiOptions, opts);
    }
    /**
     * wxpayapi调用
     *
    ...
    wxCallContainerApi(wxOpenApiOptions, opts) {
        return (0, wx_1.wxCallContainerApi)(this, wxOpenApiOptions, opts);
    }
    /**
     * 微信云调用
     *
    ...
    callCompatibleWxOpenApi(wxOpenApiOptions, opts) {
        return (0, wx_1.callCompatibleWxOpenApi)(this, wxOpenApiOptions, opts);
    }
    /**
     * 上传文件
     *
    ...
    uploadFile({ cloudPath, fileContent }, opts) {
        return (0, storage_1.uploadFile)(this, { cloudPath, fileContent }, opts);
    }
    /**
     * 删除文件
     *
    ...
    deleteFile({ fileList }, opts) {
        return (0, storage_1.deleteFile)(this, { fileList }, opts);
    }
    /**
     * 获取临时连接
     *
    ...
    getTempFileURL({ fileList }, opts) {
        return (0, storage_1.getTempFileURL)(this, { fileList }, opts);
    }
    /**
     * 下载文件
     *
    ...
    downloadFile(params, opts) {
        return (0, storage_1.downloadFile)(this, params, opts);
    }
    /**
     * 获取上传元数据
     *
    ...
    getUploadMetadata({ cloudPath }, opts) {
        return (0, storage_1.getUploadMetadata)(this, { cloudPath }, opts);
    }
    getFileAuthority({ fileList }, opts) {
        return (0, storage_1.getFileAuthority)(this, { fileList }, opts);
    }
    /**
     * 复制文件
     *
     ...
     * @param opts
     */
    copyFile({ fileList }, opts) {
        return (0, storage_1.copyFile)(this, fileList, opts);
    }
    /**
     * 获取logger
     *
    ...
    logger() {
        if (!this.clsLogger) {
            this.clsLogger = (0, log_1.logger)();
        }
        return this.clsLogger;
    }
    analytics(reportData) {
        return (0, analytics_1.analytics)(this, reportData);
    }
